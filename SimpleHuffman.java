...
//your test files (original, compressed, and uncompressed);
//create test files
//the compressed and uncompressed versions of the Constitution;
//and a document (in PDF format) with the compressed size of WarAndPeace.txt, but do not include the output.
